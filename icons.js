...
const ICONS = {
  ...
  flower: '<circle cx="12" cy="12" r="3"/><path d="M12 9V2"/><path d="M14.6 9.5 17 4"/><path d="m9.4 9.5-2.4-5.5"/><path d="M12 15v7"/><path d="M14.6 14.5 17 20"/><path d="m9.4 14.5-2.4 5.5"/><path d="M15 12h7"/><path d="M14.5 14.6 20 17"/><path d="M14.5 9.4 20 7"/><path d="M9 12H2"/><path d="M9.5 14.6 4 17"/><path d="M9.5 9.4 4 7"/>',
};
function icon(name, size = 18, cls = "") {
  const content = ICONS[name] || "";
  return `<svg class="ic ${cls}" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${content}</svg>`;
}
window.icon = icon;
window.ICONS = ICONS;

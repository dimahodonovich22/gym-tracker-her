...
const MOTIVATIONS = [
  // Сила
  { text: "Сюзанна, ты сильнее, чем думаешь!", btn: "Я сильная!" },
  { text: "Каждый подход делает тебя сильнее, Сюзанна", btn: "Становлюсь сильнее" },
  { text: "Сила внутри тебя растёт, Сюзанна", btn: "Чувствую её!" },
  { text: "Твоя сила вдохновляет", btn: "Я могу больше!" },
  { text: "Ты — сильная женщина, Сюзанна", btn: "Это я!" },
  { text: "Сила приходит к тем, кто не сдаётся", btn: "Не сдамся!" },
  { text: "Сила — это привычка. И она у тебя есть, Сюзанна", btn: "Привыкла!" },
  { text: "Твои мышцы тебе благодарны, Сюзанна", btn: "Ещё разок!" },
  { text: "Сильные руки, сильный характер", btn: "Чувствую!" },
  { text: "Ты будишь свою силу, Сюзанна", btn: "Я готова!" },
  // Красота
  { text: "Ты становишься ещё красивее, Сюзанна", btn: "Спасибо!" },
  { text: "Тренировки делают тебя сияющей", btn: "Сияю!" },
  { text: "Красота в твоём упорстве, Сюзанна", btn: "Иду до конца!" },
  { text: "Ты светишься после тренировок, Сюзанна", btn: "Чувствую свет!" },
  { text: "Каждый подход — инвестиция в красоту", btn: "Инвестирую!" },
  { text: "Твоё тело преображается, Сюзанна", btn: "Вижу!" },
  { text: "Сильная и красивая — это ты", btn: "Это я!" },
  { text: "Спортивная фигура — твой выбор, Сюзанна", btn: "Мой выбор!" },
  { text: "Красота требует усилий — и ты их прикладываешь", btn: "Знаю!" },
  { text: "Ты — ходячее вдохновение, Сюзанна", btn: "Спасибо!" },
  // Прогресс
  { text: "Сюзанна, ты ближе к цели, чем вчера", btn: "Иду к цели!" },
  { text: "Прогресс — это твой путь", btn: "Иду по нему!" },
  { text: "Каждый подход — шаг вперёд, Сюзанна", btn: "Шагаю!" },
  { text: "Сегодня ты лучше, чем вчера, Сюзанна", btn: "Завтра ещё лучше!" },
  { text: "Маленькие шаги ведут к большим победам", btn: "Иду к победе!" },
  { text: "Сюзанна, ты на правильном пути", btn: "Знаю!" },
  { text: "Прогресс виден", btn: "Замечаю!" },
  { text: "Ещё чуть-чуть до цели, Сюзанна", btn: "Достигну!" },
  { text: "Каждая тренировка приближает мечту", btn: "Близко!" },
  { text: "Видишь себя со стороны, Сюзанна? Ты крута!", btn: "Я крута!" },
  { text: "Ты выросла за эту тренировку, Сюзанна", btn: "Чувствую!" },
  { text: "Каждый подход добавляет результат", btn: "Добавляю!" },
  { text: "Прогресс не ждёт. Он у тебя в руках, Сюзанна", btn: "В моих руках!" },
  { text: "Ты создаёшь будущую себя", btn: "Создаю!" },
  { text: "Будущая ты скажет тебе спасибо, Сюзанна", btn: "Скажет!" },
  // Похвала
  { text: "Сюзанна, ты молодец!", btn: "Спасибо!" },
  { text: "Так держать, Сюзанна!", btn: "Держу!" },
  { text: "Продолжай в том же духе, Сюзанна", btn: "Продолжаю!" },
  { text: "Отличная работа, Сюзанна!", btn: "Спасибо!" },
  { text: "Ты — огонь, Сюзанна!", btn: "Я огонь!" },
  { text: "Невероятно!", btn: "Знаю!" },
  { text: "Браво, Сюзанна!", btn: "Спасибо!" },
  { text: "Это было круто, Сюзанна", btn: "Я крутая!" },
  { text: "Идеально", btn: "Стараюсь!" },
  { text: "Ты королева, Сюзанна", btn: "Я королева!" },
  { text: "Ты горишь, Сюзанна!", btn: "Чувствую!" },
  { text: "Восхищаюсь тобой, Сюзанна", btn: "Спасибо!" },
  { text: "Ты делаешь это", btn: "Я делаю!" },
  { text: "Класс, Сюзанна!", btn: "Идём дальше!" },
  { text: "Респект тебе, Сюзанна", btn: "Принято!" },
  // Упорство
  { text: "Не сдавайся, Сюзанна, ты почти там", btn: "Не сдамся!" },
  { text: "Финишная прямая близко", btn: "Дойду!" },
  { text: "Ещё немного — и ты на вершине, Сюзанна", btn: "Покорю!" },
  { text: "Сильные не сдаются, Сюзанна", btn: "Я сильная!" },
  { text: "Ты можешь больше, чем думаешь, Сюзанна", btn: "Попробую!" },
  { text: "Усталость — это слабость, покидающая тело", btn: "Уходи!" },
  { text: "Сложно — значит ты растёшь, Сюзанна", btn: "Расту!" },
  { text: "Боль уходит, гордость остаётся", btn: "Готова!" },
  { text: "Не пропускай, Сюзанна — будущая ты скажет спасибо", btn: "Делаю!" },
  { text: "Ты выбираешь себя сегодня, Сюзанна", btn: "Выбираю!" },
  { text: "Дисциплина равняется свободе", btn: "Свободна!" },
  { text: "Слабые жалуются, сильные действуют", btn: "Действую!" },
  { text: "Сила воли — твой второй мускул, Сюзанна", btn: "Качаю!" },
  { text: "Сюзанна, ты не остановишься на полпути", btn: "Не остановлюсь!" },
  { text: "Отговорки или результат — ты выбрала результат, Сюзанна", btn: "Выбрала!" },
  // Вера
  { text: "Сюзанна, я в тебя верю", btn: "Я тоже!" },
  { text: "Ты можешь всё, Сюзанна", btn: "Знаю!" },
  { text: "Невозможное — это просто непривычное", btn: "Привыкаю!" },
  { text: "Каждая чемпионка начинала с одного подхода, Сюзанна", btn: "Начала!" },
  { text: "Будь героиней своей истории, Сюзанна", btn: "Я героиня!" },
  { text: "Ты вдохновляешь", btn: "Спасибо!" },
  { text: "Ты способна на большее, Сюзанна", btn: "Покажу!" },
  { text: "Сильные женщины меняют мир", btn: "Меняю!" },
  { text: "Ты создаёшь свою лучшую версию, Сюзанна", btn: "Создаю!" },
  { text: "Сюзанна, ты не такая, как все. Ты — лучше", btn: "Спасибо!" },
  { text: "Ты выбираешь быть сильной, Сюзанна", btn: "Выбираю!" },
  { text: "Твоя сила — пример другим", btn: "Это я!" },
  { text: "Только вперёд, Сюзанна!", btn: "Только так!" },
  { text: "Чемпионки тренируются даже когда не хотят, Сюзанна", btn: "Я чемпионка!" },
  { text: "Ты делаешь то, на что многие не решаются, Сюзанна", btn: "Я смелая!" },
  // Конкретное
  { text: "Это был мощный подход, Сюзанна!", btn: "Дальше!" },
  { text: "Видела, как ты подняла, Сюзанна? Огонь!", btn: "Огонь!" },
  { text: "Этот подход тебе зачёт", btn: "Спасибо!" },
  { text: "Ты сегодня в ударе, Сюзанна", btn: "В ударе!" },
  { text: "Подход в копилку", btn: "Копим!" },
  { text: "Один подход ближе к идеалу, Сюзанна", btn: "Иду!" },
  { text: "Тебе это даётся всё легче, Сюзанна", btn: "Замечаю!" },
  { text: "Сюзанна, это твой день", btn: "Мой день!" },
  { text: "Ты только что стала сильнее, Сюзанна", btn: "Чувствую!" },
  { text: "Сюзанна, ты сегодня себя удивляешь", btn: "Удивляюсь!" },
  // Восторг
  { text: "Ура, Сюзанна! Ещё один подход", btn: "Ура!" },
  { text: "Йес! Так держать, Сюзанна", btn: "Йес!" },
  { text: "Wow, Сюзанна, как круто!", btn: "Спасибо!" },
  { text: "Воу-воу, какая ты, Сюзанна!", btn: "Какая есть!" },
  { text: "Огонь!", btn: "Жгу!" },
  { text: "Бомбически, Сюзанна", btn: "Бомба!" },
  { text: "Топчик, Сюзанна!", btn: "Я топ!" },
  { text: "Сильно, очень сильно, Сюзанна", btn: "Спасибо!" },
  { text: "Гордимся тобой, Сюзанна", btn: "Спасибо!" },
  { text: "Так-так, Сюзанна, кто это у нас тут такая молодец?", btn: "Это я!" },
];
...
function showWelcome() {
  ...
  el.innerHTML = `
    <div class="welcome-card" role="dialog" aria-label="Приветствие">
      ...
      <div class="welcome-title">Привет, Сюзанна!</div>
